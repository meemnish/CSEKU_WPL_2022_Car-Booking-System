...
<body style="background:url(pics/new.jpg);
             background-size:100%;
...
<?php
        ...
        <p align='center'> <font size='3' face='arial' text color='white'>  <a href="index2.php"><h2 align='center'><br><br>Back to homepage</h2></a></p>
   </body>
</html>