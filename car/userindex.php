...
<section class="home" id="home">
    <h3>rent any car</h3>
    <img src="img/home.jpg" height=450 alt=""> 
...
<section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h3>Why choose us</h3>
            <p>
            no hidden fees | no credit card fees | no amendment fees | book directly through supplier
            </p>
        </div>
...
<?php $sql = "SELECT vehicles.VehiclesTitle,brands.BrandName,vehicles.PricePerDay,
vehicles.FuelType,vehicles.ModelYear,vehicles.id,vehicles.SeatingCapacity,
vehicles.VehiclesOverview,vehicles.Vimage1,vehicles.Vimage2,vehicles.Vimage3,vehicles.Vimage4 
from vehicles join brands on brands.id=vehicles.VehiclesBrand";
...
<section class="contact" id="contact">
    ...
    <form action="">
    <h3>About us</h3>
    <h2>Rent & Ride now has a new face. After more than 5 years in business, we decided to give a fresher look to our brand
    and our services. With our fully renewed fleet of vehicles, we are ready to meet all expectations and requirements.<br><br>
    rentandride.com is a trading name of Booking.com Transport Limited which is a limited company registered in Bangladesh 
    (Number: 01234567890) whose registered address is at 189, Malibag DIT Road, Dhaka-1217 and VAT number: GB 855349007.
    </h2>
    <p align='center'> <font size='5' face='arial' text color='white'>  <a href="show_r_out.php"><h5> See the reviews </h5></a></p>
    </form>
    </div>
</section>
