...
else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?><table align='right' border="1" id="zctb"  cellspacing="0" width="70%">
<thead>
<tr>
<th>Vehicle Title</th>
<th>Brand </th>
...
vehicles.ModelYear,vehicles.id from vehicles join brands on brands.id=vehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
...
<td><a href="5.1.edit-car.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="5.manage-cars.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-archive"></i></a></td>
</tr>
